...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Sistema de monitoramento e gestão de tarefas do Redmine"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Redmine Dashboard - Brobot"};
